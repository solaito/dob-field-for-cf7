...
function dob_field_for_cf7_form_tag_handler( $tag ) {
	...
	$html_parts = [
		'year'  => dob_field_for_cf7_form_part( $tag, $atts, 'year', $default_value['year'], range( $start_year, $until_year ), esc_html( __( 'Year', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ) ),
		'month' => dob_field_for_cf7_form_part( $tag, $atts, 'month', $default_value['month'], range( 1, 12 ), esc_html( __( 'Month', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ) ),
		'day'   => dob_field_for_cf7_form_part( $tag, $atts, 'day', $default_value['day'], range( 1, 31 ), esc_html( __( 'Day', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ) )
	];
...
function dob_field_for_cf7_validation_filter( $result, $tag ) {
	...
	if ( ! in_array( false, $blank_flags, true ) !== false ) {
		...
		// 数値が入力されていた場合のチェック
		$result->invalidate( $tag, __( 'The date specified is not a valid date value.', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) );
	}
...
function dob_field_for_cf7_add_tag_generator_dob() {
	...
	$tag_generator->add( 'dob', __( 'DOB', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ),
...
function dob_field_for_cf7_tag_generator_dob( $contact_form, $args = '' ) {
	...
	$description = __( "Generate a form-tag for a date of birth input field.", DOB_FIELD_FOR_CF7_TEXT_DOMAIN );
	...
	<div class="control-box">
		<fieldset>
			...
			<table class="form-table">
				<tbody>
				<tr>
					<th scope="row"><?php echo esc_html( __( 'Field type', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></th>
					<td>
						<fieldset>
							<legend
								class="screen-reader-text"><?php echo esc_html( __( 'Field type', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></legend>
							<label><input type="checkbox"
										  name="required"/> <?php echo esc_html( __( 'Required field', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?>
							</label>
						</fieldset>
					</td>
				</tr>
				...
				<tr>
					<th scope="row"><label
							for="<?php echo esc_attr( $args['content'] . '-name' ); ?>"><?php echo esc_html( __( 'Name', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
					</th>
				...
				<tr>
					<th scope="row"><label
							for="<?php echo esc_attr( $args['content'] . '-values' ); ?>"><?php echo esc_html( __( 'Default value', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
					</th>
				...
				<tr>
					<th scope="row"><?php echo esc_html( __( 'Options', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></th>
					<td>
						<fieldset>
							<legend
								class="screen-reader-text"><?php echo esc_html( __( 'Options', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></legend>
							<label><input type="checkbox" name="include_blank"
										  class="option"/> <?php echo esc_html( __( 'Insert a blank item as the first option', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?>
							</label>
						</fieldset>
					</td>
				</tr>
				...
				<tr>
					<th scope="row" rowspan="3"><?php echo esc_html( __( 'Date Format', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></th>
					<td>
						<fieldset>
							<legend><?php echo esc_html( __( 'Date Style', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></legend>
				...
				<tr>
					<td>
						<fieldset>
							<legend><?php echo esc_html( __( 'Date Separator', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></legend>
							<input type="radio" name="separator" class="separatorvalue option"
								   id="<?php echo esc_attr( $args['content'] . '-separator-slash' ); ?>" value="slash"
								   checked>
							<label
								for="<?php echo esc_attr( $args['content'] . '-separator-slash' ); ?>"><?php echo esc_html( __( 'slash', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
							<input type="radio" name="separator" class="separatorvalue option"
								   id="<?php echo esc_attr( $args['content'] . '-separator-dash' ); ?>" value="dash">
							<label
								for="<?php echo esc_attr( $args['content'] . '-separator-dash' ); ?>"><?php echo esc_html( __( 'dash', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
							<input type="radio" name="separator" class="separatorvalue option"
								   id="<?php echo esc_attr( $args['content'] . '-separator-period' ); ?>"
								   value="period">
							<label
								for="<?php echo esc_attr( $args['content'] . '-separator-period' ); ?>"><?php echo esc_html( __( 'period', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
							<input type="radio" name="separator" class="separatorvalue option"
								   id="<?php echo esc_attr( $args['content'] . '-separator-comma' ); ?>" value="comma">
							<label
								for="<?php echo esc_attr( $args['content'] . '-separator-comma' ); ?>"><?php echo esc_html( __( 'comma', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
							<input type="radio" name="separator" class="separatorvalue option"
								   id="<?php echo esc_attr( $args['content'] . '-separator-blank' ); ?>" value="blank">
							<label
								for="<?php echo esc_attr( $args['content'] . '-separator-blank' ); ?>"><?php echo esc_html( __( 'blank', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
						</fieldset>
					</td>
				</tr>
				...
				<tr>
					<td>
						<fieldset>
							<legend><?php echo esc_html( __( 'Display Leading Zero', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></legend>
							<label><input type="checkbox" name="leading_zero"
										  class="option"/> <?php echo esc_html( __( 'Indicates whether to display (or suppress) leading zeros.', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?>
							</label>
						</fieldset>
					</td>
				</tr>
				...
				<tr>
					<th scope="row"><label
							for="<?php echo esc_attr( $args['content'] . '-id' ); ?>"><?php echo esc_html( __( 'Id attribute', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
					</th>
				...
				<tr>
					<th scope="row"><label
							for="<?php echo esc_attr( $args['content'] . '-class' ); ?>"><?php echo esc_html( __( 'Class attribute', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?></label>
					</th>
	...
	<div class="insert-box">
		...
		<div class="submitbox">
			<input type="button" class="button button-primary insert-tag"
				   value="<?php echo esc_attr( __( 'Insert Tag', DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ); ?>"/>
		</div>

		<br class="clear"/>

		<p class="description mail-tag"><label
				for="<?php echo esc_attr( $args['content'] . '-mailtag' ); ?>"><?php echo sprintf( esc_html( __( "To use the value input through this field in a mail field, you need to insert the corresponding mail-tag (%s) into the field on the Mail tab.", DOB_FIELD_FOR_CF7_TEXT_DOMAIN ) ), '<strong><span class="mail-tag"></span></strong>' ); ?>
