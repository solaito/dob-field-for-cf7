...
<tbody>
	...
	<tr>
	<th scope="row"><label for="<?php echo esc_attr($args['content'] . '-target'); ?>"><?php echo esc_html(__('Target name*', 'watts')); ?></label></th>
	<td><input type="text" name="target" class="targetvalue oneline option" id="<?php echo esc_attr($args['content'] . '-target'); ?>" /></td>
	</tr>
